...
1. **ADR-004 build step 3** — write Decisions 1 and 3 into C2, C5 and
   criterion 7, including the `param-overview-max-words` re-measurement from
   227 to 206.
...
5. **Phase 6.2** does not close until `param-low-confidence-threshold` is
